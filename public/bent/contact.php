...
define("__TO__", "alle.fagelbacken@gmail.com);

//Success message
define('__SUCCESS_MESSAGE__', "Ditt meddlande har skickats! Tack så mycket!");

//Error message 
define('__ERROR_MESSAGE__', "Oj, nått gick visst fel! Testa igen!");
